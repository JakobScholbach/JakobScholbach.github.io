...
<span id="ex-subspace-statements" label="ex:subspace-statements"></span> (See <a href="../solutions-vector-spaces/#sol-ex-subspace-statements" data-reference-type="ref+Label" data-reference="sol--ex:subspace-statements">Solution 3.2</a>.) Let $V \subset {\bf R}^2$ be a subspace. Which of the following statements are correct?
...
<span id="ex-union-subspaces" label="ex:union-subspaces"></span> (See <a href="../solutions-vector-spaces/#sol-ex-union-subspaces" data-reference-type="ref+Label" data-reference="sol--ex:union-subspaces">Solution 3.4</a>.) Give an example of two subspaces $V, W \subset {\bf R}^2$ such that their *union*
<div class="arithmatex" markdown="1">
\[
...
<span id="ex-spanning-r4" label="ex:spanning-r4"></span> (See <a href="../solutions-vector-spaces/#sol-ex-spanning-r4" data-reference-type="ref+Label" data-reference="sol--ex:spanning-r4">Solution 3.6</a>.) Determine whether the following vectors span ${\bf R}^4$:
...
<span id="ex-linear-independence" label="ex:linear-independence"></span> (See <a href="../solutions-vector-spaces/#sol-ex-linear-independence" data-reference-type="ref+Label" data-reference="sol--ex:linear-independence">Solution 3.7</a>.) Determine whether the following vectors are linearly independent:
...
<span id="ex-three-vectors-r2" label="ex:three-vectors-r2"></span> (See <a href="../solutions-vector-spaces/#sol-ex-three-vectors-r2" data-reference-type="ref+Label" data-reference="sol--ex:three-vectors-r2">Solution 3.8</a>.) Name three vectors $v_1, v_2, v_3 \in {\bf R}^2$ such that:
...
<span id="ex-poly-span-1" label="ex poly span 1"></span> (See <a href="../solutions-vector-spaces/#sol-ex-poly-span-1" data-reference-type="ref+Label" data-reference="sol--ex poly span 1">Solution 3.10</a>.) Express the following polynomials as linear combinations of $x+1$, $x-1$ and $x^2-1$ (in ${\bf R}[x]^{\le 2})$: $x^2 + 4x-2$, $x$, $40-x^2$.
...
<span id="base-change-matrix" label="base change matrix"></span> (See <a href="../solutions-vector-spaces/#sol-base-change-matrix" data-reference-type="ref+Label" data-reference="sol--base change matrix">Solution 3.12</a>.) Express each of the three standard basis vectors $e_1, e_2, e_3$ as a linear combination of the basis vectors in <a href="../spaces-bases/#ex-three-vectors-basis" data-reference-type="ref+Label" data-reference="ex:three-vectors-basis">Example 3.63</a>.
...
<span id="ex-matrix-subspace" label="ex:matrix-subspace"></span> (See <a href="../solutions-vector-spaces/#sol-ex-matrix-subspace" data-reference-type="ref+Label" data-reference="sol--ex:matrix-subspace">Solution 3.14</a>.) In the vector space ${\mathrm {Mat}}_{2 \times 3}$ of $2 \times 3$-matrices, we consider the set
<div class="arithmatex" markdown="1">
\[
...
<span id="ex-spaces-2-2" label="ex:spaces-2-2"></span> (See <a href="../solutions-vector-spaces/#sol-ex-spaces-2-2" data-reference-type="ref+Label" data-reference="sol--ex:spaces-2-2">Solution 3.15</a>.) In ${\bf R}^4$ consider the subset
<div class="arithmatex" markdown="1">
\[
S = \{(x,y,z,t) \ | \ x+y+z+t = 0 \}.
\]
...
<span id="ex-spaces-2-3" label="ex:spaces-2-3"></span> (See <a href="../solutions-vector-spaces/#sol-ex-spaces-2-3" data-reference-type="ref+Label" data-reference="sol--ex:spaces-2-3">Solution 3.16</a>.) Consider the following two subspaces of ${\bf R}^4$:
<div class="arithmatex" markdown="1">
\[
...
<span id="ex-intersection-tw" label="ex:intersection-tw"></span> (See <a href="../solutions-vector-spaces/#sol-ex-intersection-tw" data-reference-type="ref+Label" data-reference="sol--ex:intersection-tw">Solution 3.17</a>.) Consider the following two subspaces of ${\bf R}^4$:
<div class="arithmatex" markdown="1">
\[
...
<span id="ex-r2-spanning" label="ex:r2-spanning"></span> (See <a href="../solutions-vector-spaces/#sol-ex-r2-spanning" data-reference-type="ref+Label" data-reference="sol--ex:r2-spanning">Solution 3.18</a>.) Show that
...
<span id="ex-linear-combination-r3" label="ex:linear-combination-r3"></span> (See <a href="../solutions-vector-spaces/#sol-ex-linear-combination-r3" data-reference-type="ref+Label" data-reference="sol--ex:linear-combination-r3">Solution 3.19</a>.) Is $(1,5,0) \in {\bf R}^3$ a linear combination of $v_1 = (1,1,0)$, $v_2 = (2,0,1)$ and $v_3 = (0,3,-1)$?
...
<span id="ex-polynomial-basis-change" label="ex:polynomial-basis-change"></span> (See <a href="../solutions-vector-spaces/#sol-ex-polynomial-basis-change" data-reference-type="ref+Label" data-reference="sol--ex:polynomial-basis-change">Solution 3.20</a>.) Express the following polynomials as $f(x) = \sum_{i=0}^4 a_i (x-1)^i$:
...
<span id="ex-basis-w1-r4" label="ex:basis-w1-r4"></span> (See <a href="../solutions-vector-spaces/#sol-ex-basis-w1-r4" data-reference-type="ref+Label" data-reference="sol--ex:basis-w1-r4">Solution 3.22</a>.) In ${\bf R}^4 = \{(x,y,z,t) \ | \ x,y,z,t \in {\bf R} \}$ consider the subspace $W_1 \subset {\bf R}^4$ given by the solutions of the system
<div class="arithmatex" markdown="1">
\[
\begin{align*}
y+t&=0, \\
...
<span id="ex-wk-basis" label="ex:wk-basis"></span> (See <a href="../solutions-vector-spaces/#sol-ex-wk-basis" data-reference-type="ref+Label" data-reference="sol--ex:wk-basis">Solution 3.23</a>.) Let $k \in {\bf R}$ be an arbitrary real number. Consider the subspace
<div class="arithmatex" markdown="1">
\[
...
<span id="ex-mat-subspace-dim" label="ex:mat-subspace-dim"></span> (See <a href="../solutions-vector-spaces/#sol-ex-mat-subspace-dim" data-reference-type="ref+Label" data-reference="sol--ex:mat-subspace-dim">Solution 3.24</a>.) Recall that the dimension of the space ${\mathrm {Mat}}_{2 \times 3}$ of $2 \times 3$-matrices is 6.
...
<span id="ex-spaces-2-4" label="ex:spaces-2-4"></span> (See <a href="../solutions-vector-spaces/#sol-ex-spaces-2-4" data-reference-type="ref+Label" data-reference="sol--ex:spaces-2-4">Solution 3.25</a>.) Consider the following subspaces of ${\bf R}^3$:
<div class="arithmatex" markdown="1">
\[
\begin{align*}
W_1 & := L((1,0,1), (2,1,0)) \\
...
<span id="ex-sum-intersection-r4" label="ex:sum-intersection-r4"></span> (See <a href="../solutions-vector-spaces/#sol-ex-sum-intersection-r4" data-reference-type="ref+Label" data-reference="sol--ex:sum-intersection-r4">Solution 3.26</a>.) Consider the following subspaces of ${\bf R}^4$:
<div class="arithmatex" markdown="1">
\[
\begin{align*}
...
<span id="ex-spaces-2-5" label="ex:spaces-2-5"></span> (See <a href="../solutions-vector-spaces/#sol-ex-spaces-2-5" data-reference-type="ref+Label" data-reference="sol--ex:spaces-2-5">Solution 3.27</a>.) Consider the subspace
<div class="arithmatex" markdown="1">
\[
...
<span id="ex-spaces-2-6" label="ex:spaces-2-6"></span> (See <a href="../solutions-vector-spaces/#sol-ex-spaces-2-6" data-reference-type="ref+Label" data-reference="sol--ex:spaces-2-6">Solution 3.28</a>.) Consider the vectors in ${\bf R}^4$, where $t \in {\bf R}$:
<div class="arithmatex" markdown="1">
\[
\begin{align*}
u_1 &= (1,0,-1,2) \\
...
<span id="ex-ut-basis-r4" label="ex:ut-basis-r4"></span> (See <a href="../solutions-vector-spaces/#sol-ex-ut-basis-r4" data-reference-type="ref+Label" data-reference="sol--ex:ut-basis-r4">Solution 3.29</a>.) Consider the subspace $U_t \subset {\bf R}^4$ spanned by the four vectors
<div class="arithmatex" markdown="1">
\[
\begin{align*}
v_1 & = (1,0, 0, 1) \\
